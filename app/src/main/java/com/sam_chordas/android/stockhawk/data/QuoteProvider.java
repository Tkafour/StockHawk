...
public class QuoteProvider {
    ...
    interface Path {
        ...
        String HistoryQuotes = "history_quotes";
    }
    ...
    @TableEndpoint(table = QuoteDatabase.HistoryQuotes)
    public static class HistoryQuotes {
        @ContentUri(
                path = Path.HistoryQuotes,
                type = "vnd.android.cursor.dir/history_quotes"
        )
        public static final Uri CONTENT_URI = buildUri(Path.HistoryQuotes);
